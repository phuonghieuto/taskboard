...
class AuthControllerTest {
    ...
    void loginUser_Success() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/auth/login").contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(loginRequest))).andDo(result -> {
    ...
    void loginUser_UserNotFound() throws Exception {
        ...
        resultActions.andExpect(status().isNotFound()).andExpect(jsonPath("$.isSuccess").value(false))
                .andExpect(jsonPath("$.message").value("User not found with email: " + loginRequest.getEmail()))
    ...
    void refreshToken_Success() throws Exception {
        ...
        // Act
        ResultActions resultActions = mockMvc.perform(post("/auth/refresh-token")
                .contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(refreshRequest)));
    ...
    void logout_Success() throws Exception {
        ...
        // Act
        ResultActions resultActions = mockMvc.perform(post("/auth/logout").contentType(MediaType.APPLICATION_JSON)
    ...
    void validateToken_InvalidToken() throws Exception {
        ...
        doThrow(new RuntimeException("Invalid or expired token")).when(tokenValidationService).verifyAndValidate(token);
    ...
    void getAuthentication_Success() throws Exception {
        ...
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(
                "test@example.com", null, Collections.singletonList(new SimpleGrantedAuthority("USER")));
