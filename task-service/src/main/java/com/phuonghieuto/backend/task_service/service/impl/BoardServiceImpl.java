...
public class BoardServiceImpl implements BoardService {
    ...
    private final BoardRequestToBoardEntityMapper boardRequestToBoardEntityMapper = BoardRequestToBoardEntityMapper.initialize();
    private final BoardEntityToBoardResponseMapper boardEntityToBoardResponseMapper = BoardEntityToBoardResponseMapper.initialize();
