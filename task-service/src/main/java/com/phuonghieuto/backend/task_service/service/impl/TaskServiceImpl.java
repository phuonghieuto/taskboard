...
public class TaskServiceImpl implements TaskService {
    ...
    private final TaskRequestToTaskEntityMapper taskRequestToTaskEntityMapper = TaskRequestToTaskEntityMapper.initialize();
    private final TaskEntityToTaskResponseMapper taskEntityToTaskResponseMapper = TaskEntityToTaskResponseMapper.initialize();
    ...
    public List<TaskResponseDTO> getAllTasksByTableId(String tableId) {
        ...
        return tasks.stream()
                .map(taskEntityToTaskResponseMapper::map)
    ...
    public List<TaskResponseDTO> getAllTasksByAssignedUserId(String userId) {
        ...
        List<TaskEntity> accessibleTasks = tasks.stream()
            .filter(task -> hasAccessToTaskBoard(task, currentUserId))
            .collect(Collectors.toList());
